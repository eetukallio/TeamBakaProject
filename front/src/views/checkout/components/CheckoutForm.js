                        ...
                        <Row>
                            ...
                            <Col >
                                <FormGroup controlId="zipCodeField" validationState={this.getZipCodeValidationState()}>
                                    ...
                                    <FormControl type="text" name="zipCode" value={this.props.data.zipCode} onChange={this.changeForm.bind(this)} required />
                                    <FormControl.Feedback />
                                </FormGroup>
                            </Col>
                        ...
                        <Row>
                            <Col>
                                <FormGroup controlId="streetAddressField" validationState={this.getCountryValidationState()}>
                                    ...
                                    <FormControl componentClass="select" placeholder="Select Country" name="country" value={this.props.data.country} onChange={this.changeForm.bind(this)} required >
